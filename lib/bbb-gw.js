...
module.exports = class BigBlueButtonGW extends EventEmitter {
  ...
  incomingMessage (message) {
    ...
    if (header) {
      switch (header.name) {
        case "UserSpeechLocaleChangedEvtMsg":

          if (this._listeners["UserSpeechLocaleChangedEvtMsg"]) {
            this._listeners["UserSpeechLocaleChangedEvtMsg"](header, payload);
          }
          break;

        case "UserSpeechOptionsChangedEvtMsg":

          if (this._listeners["UserSpeechOptionsChangedEvtMsg"]) {
            this._listeners["UserSpeechOptionsChangedEvtMsg"](header, payload);
          }
          break;
